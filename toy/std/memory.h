...
#ifndef TOY_STD_MEMORY_H
#define TOY_STD_MEMORY_H
...
public:
	...
	pointer& _ptr()				noexcept { return cpair._Get_second(); }
	const pointer& _ptr() const noexcept { return cpair._Get_second(); }
...
public:
	...
	{	// swap elements
		std::_Swap_adl(this->_ptr(), right._ptr());
